...
export function HomeFooter() {
  return (
    <footer className="mt-8 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 rounded-2xl bg-[#eaf6df] px-6 py-5 text-center text-sm font-medium text-[#0d3f1e]">
