...
export function LowerPanel({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="rounded-lg bg-gradient-to-r from-green-600 to-teal-600 p-2">
        <label className="block text-center text-xs font-bold text-white mb-1">
        ...
        <input
          ...
          readOnly
          className="w-full rounded border border-white bg-white px-2 py-2 text-center text-2xl font-bold text-gray-900 focus:outline-none"
        />
      </div>

      {/* A1, B1, B2 counter row - three equal cards */}
