  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white overflow-hidden">
      ...
      <div className="p-2 space-y-2">
        ...
        <button className={`w-full ${bgColor} hover:opacity-90 text-white font-bold py-2 px-3 rounded transition-opacity text-sm flex items-center justify-center gap-1`}>
          <span>➤</span>
          <span>SEND</span>
        </button>
      </div>
