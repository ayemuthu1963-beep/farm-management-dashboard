    ...
    try {
      ...
      const conflicts = saved.conflicts.map((item) => (
        item.conflict_type === "same_plot_overlap"
          ? `${item.candidate_plot} is already irrigated by ${item.motor_id.replace("motor-", "Motor ")} during this time.`
