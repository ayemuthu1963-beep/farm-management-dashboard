...
assert.equal(manifest.release_note, "Move Farm Map orthomosaic details and overlay note to the bottom row")
assert.equal(manifest.base_commit, "10e289806c33d4a5544879e3b10669d2931bf97f")
