...
assert.match(deployScript, /with \.IPAMConfig.*\.IPv4Address/)
...
assert.match(deployScript, /MFMS_TRUST_PROXY_ACTOR_HEADERS=true/)
assert.match(deployScript, /MFMS_WORKER_PROXY_DEFAULT_ROLE=admin/)
