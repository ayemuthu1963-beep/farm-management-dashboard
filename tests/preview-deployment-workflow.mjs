...
assert.equal(
  ...
  "Fix Preview irrigation schedule identity forwarding and standardize displayed rain reasons",
)
assert.equal(manifest.base_commit, "910b52def44de93b57c9c8420fd095771577a773")
