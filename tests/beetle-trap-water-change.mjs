...
assert.match(dashboard, /colSpan=\{8\}/)
...
assert.match(chart, /BEETLE_LURE_SERIES.map/)
assert.match(chart, /strokeDasharray=\{series.plot === 2 \? "5 3" : undefined\}/)
...
console.log("Beetle Trap water-change and eight-line company trend contracts passed.")
