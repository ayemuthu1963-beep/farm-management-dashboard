...
assert.match(proxy, /resolvePipelineActor\(request\.headers, process\.env, method\)/)
assert.match(proxy, /signActorAssertion/)
assert.match(proxy, /signAuthenticatedUserAssertion/)
assert.doesNotMatch(proxy, /getAuthenticatedUserAssertionHeaders/)
