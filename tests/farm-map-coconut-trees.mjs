...
// Current Farm Map uses the latest sanitized three-crop assets; historical assets above remain unchanged.
assert.match(mapClient, /FARM_TREE_SOURCES/)
assert.match(mapClient, /FarmMapOrthomosaic/)
assert.match(mapClient, /preferCanvas/)
assert.match(mapClient, /Tree Layers & Legend/)
assert.doesNotMatch(mapClient, /canonicalTreeNo|jackfruitCoordinatesUrl|formatJackfruitTreeNo/)
