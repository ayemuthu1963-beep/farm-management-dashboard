...
| `test-release` | Exact Test candidate/baseline | Only through a guarded Test workflow |
| `preview-release` | Exact Preview candidate/baseline | Only through the existing guarded Preview workflow |
