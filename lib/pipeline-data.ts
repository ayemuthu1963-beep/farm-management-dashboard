...
export const pipelineSegments: PipelineSegment[] = [
  { segmentId: "P-01", route: "Well 1 → Plot 2", material: "PVC 90mm", lengthM: 320, lastInspected: "03-07-2026", status: "Healthy" },
  { segmentId: "P-02", route: "Plot 2 East line", material: "PVC 63mm", lengthM: 210, lastInspected: "03-07-2026", status: "Monitor" },
  { segmentId: "P-03", route: "Plot 2 West line", material: "PVC 63mm", lengthM: 190, lastInspected: "02-07-2026", status: "Leak" },
  { segmentId: "P-04", route: "Well 2 → Plot 1", material: "PVC 90mm", lengthM: 360, lastInspected: "04-07-2026", status: "Healthy" },
  { segmentId: "P-05", route: "Plot 1 East line", material: "PVC 63mm", lengthM: 230, lastInspected: "01-07-2026", status: "Leak" },
...
export const pipelineIssues: PipelineIssue[] = [
  { segmentId: "P-03", location: "Plot 2 West", issue: "Joint leak near valve 4", reported: "02-07-2026", severity: "High" },
  { segmentId: "P-05", location: "Plot 1 East", issue: "Cracked pipe section", reported: "01-07-2026", severity: "High" },
  { segmentId: "P-02", location: "Plot 2 East", issue: "Low pressure reported", reported: "03-07-2026", severity: "Medium" },
