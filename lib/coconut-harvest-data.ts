...
export interface PerformanceRow {
  ...
  maxNuts: number
  averageNuts: number
  /** Trees in this category reported in the latest bunch-tying round. */
  tiedTreesReported: number
  /** Total bunches tied for this category in the latest tying round. */
  tiedBunchesTotal: number
  /** Average tied bunches per reported tree in the latest tying round. */
  averageTiedBunches: number
}

/** Plot 1 — tree numbers 1 to 999. */
export const plot1Performance: PerformanceRow[] = [
  { rank: 1, category: "💯 Century Maker", criteria: "Over 400 nuts in last 10 harvests", treeCount: 62, minNuts: 401, maxNuts: 545, averageNuts: 434.58, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 2, category: "🔥 Match Winner", criteria: "300 to 399 nuts in last 10 harvests", treeCount: 275, minNuts: 300, maxNuts: 398, averageNuts: 341.62, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 3, category: "👍 Reliable Batter", criteria: "225 to 299 nuts in last 10 harvests", treeCount: 208, minNuts: 225, maxNuts: 299, averageNuts: 264.79, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 4, category: "😬 Tail Ender", criteria: "175 to 224 nuts in last 10 harvests", treeCount: 68, minNuts: 176, maxNuts: 224, averageNuts: 199.31, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 5, category: "🪑 Bench Player", criteria: "Less than 175 nuts in last 10 harvests", treeCount: 341, minNuts: 0, maxNuts: 172, averageNuts: 26.37, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
]

/** Plot 2 — tree numbers above 1000. */
export const plot2Performance: PerformanceRow[] = [
  { rank: 1, category: "🔥 Match Winner", criteria: "200 to 299 nuts in last 10 harvests", treeCount: 36, minNuts: 200, maxNuts: 290, averageNuts: 224.58, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 2, category: "👍 Reliable Batter", criteria: "150 to 199 nuts in last 10 harvests", treeCount: 145, minNuts: 150, maxNuts: 198, averageNuts: 170.91, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 3, category: "😬 Tail Ender", criteria: "100 to 149 nuts in last 10 harvests", treeCount: 359, minNuts: 100, maxNuts: 149, averageNuts: 123.9, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
  { rank: 4, category: "🪑 Bench Player", criteria: "Less than 100 nuts in last 10 harvests", treeCount: 623, minNuts: 0, maxNuts: 99, averageNuts: 39.33, tiedTreesReported: 0, tiedBunchesTotal: 0, averageTiedBunches: 0 },
]
