    ...
    <DashboardShell>
      <div className="space-y-6">
        ...
        <section className="rounded-2xl border border-primary/15 bg-card p-6 shadow-sm">
          <p className="text-xs font-extrabold uppercase tracking-[0.24em] text-primary">{environmentLabel} Harvest Admin</p>
          ...
          <div className="mt-4 grid gap-2 text-sm sm:grid-cols-2 lg:grid-cols-3">
            ...
            <p><span className="font-extrabold">ODK Project:</span> {projectId}</p>
