          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm font-medium text-muted-foreground">
                {isProduction
                  ? "Production administration hub. Authorised entries are saved to the verified live Production database."
                  : "Isolated administration hub. Entries are restricted to the verified environment database."}
              </p>
            </div>
