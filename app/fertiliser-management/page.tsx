          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" role="dialog" aria-modal="true">
            <div className="w-full max-w-xl rounded-xl border border-border bg-card p-5 shadow-xl">
              ...
              <form onSubmit={(event) => submitMasterCreate(event, activeModal === "product" ? "Product" : "Category")} className="space-y-4">
                ...
                <div className="rounded-lg bg-muted/60 p-3 text-sm text-muted-foreground">The new record will be saved only to the guarded {fertiliserIdentity.label} database and will appear in the master tables immediately.</div>
