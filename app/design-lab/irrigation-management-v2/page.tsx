...
const totalWaterPumpedTrend = [
  { date: '04 Jul', total: 8100 },
  { date: '05 Jul', total: 8350 },
  { date: '06 Jul', total: 8600 },
  { date: '07 Jul', total: 8750 },
  { date: '08 Jul', total: 8700 },
  { date: '09 Jul', total: 8900 },
  { date: '10 Jul', total: 9000 },
  { date: '11 Jul', total: 9000 },
  { date: '12 Jul', total: 9000 },
  { date: '13 Jul', total: 9100 },
]

const dailyIrrigationTrend = [
  { date: '04 Jul', P1E: 120, P1W: 100, P2E: 80, P2W: 75, JF: 60, NM: 45 },
  { date: '05 Jul', P1E: 125, P1W: 105, P2E: 85, P2W: 78, JF: 62, NM: 45 },
  { date: '06 Jul', P1E: 130, P1W: 108, P2E: 88, P2W: 82, JF: 65, NM: 45 },
  { date: '07 Jul', P1E: 132, P1W: 110, P2E: 90, P2W: 85, JF: 66, NM: 45 },
  { date: '08 Jul', P1E: 130, P1W: 108, P2E: 92, P2W: 87, JF: 67, NM: 45 },
  { date: '09 Jul', P1E: 133, P1W: 109, P2E: 91, P2W: 88, JF: 68, NM: 45 },
  { date: '10 Jul', P1E: 134, P1W: 110, P2E: 92, P2W: 88, JF: 68, NM: 45 },
  { date: '11 Jul', P1E: 134, P1W: 110, P2E: 92, P2W: 88, JF: 68, NM: 45 },
  { date: '12 Jul', P1E: 134, P1W: 110, P2E: 92, P2W: 88, JF: 68, NM: 45 },
  { date: '13 Jul', P1E: 135, P1W: 110, P2E: 92, P2W: 88, JF: 68, NM: 45 },
]
    ...
    <DashboardShell>
      ...
      <main className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {/* Total Water Pumped — Date Wise (Line Chart) */}
          ...
          <Panel title="Daily Irrigation Trend" icon={Droplets}>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={dailyIrrigationTrend}>
                <CartesianGrid strokeDasharray="3 3" stroke="var(--color-border)" />
                <XAxis dataKey="date" tick={{ fontSize: 12 }} stroke="var(--color-muted-foreground)" />
                <YAxis tick={{ fontSize: 12 }} stroke="var(--color-muted-foreground)" />
                <Tooltip contentStyle={{ backgroundColor: 'var(--color-card)', border: '1px solid var(--color-border)' }} />
                <Legend />
                <Bar dataKey="P1E" fill="rgb(34, 197, 94)" />
                <Bar dataKey="P1W" fill="rgb(59, 130, 246)" />
                <Bar dataKey="P2E" fill="rgb(249, 115, 22)" />
                <Bar dataKey="P2W" fill="rgb(168, 85, 247)" />
                <Bar dataKey="JF" fill="rgb(236, 72, 153)" />
                <Bar dataKey="NM" fill="rgb(14, 165, 233)" />
              </BarChart>
            </ResponsiveContainer>
          </Panel>
        </div>
